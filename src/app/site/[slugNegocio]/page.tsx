...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const baseUrl = `https://${negocio.subdominio}.localseo.com.br`;
  ...
  return gerarMetadataSeo({
    ...
    descricao:
      ...
      lp?.subtitulo ||
      negocio.descricao ||
      `Bem-vindo ao ${negocio.nome}. Saiba mais sobre nossos serviços.`,
    url: baseUrl,
      ...
      <header className="relative pt-40 pb-20 sm:pt-48 sm:pb-32 z-10">
        <div className="container mx-auto px-4 max-w-5xl flex flex-col items-center text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-primary/30 text-xs font-bold uppercase tracking-widest mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-cyan-400">Destaque na sua região</span>
          </div>
        ...
        <section className="relative py-24 z-10 border-t border-white/5 bg-white/[0.02]">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center mb-16">
              <h2 className="text-4xl sm:text-5xl font-bold tracking-tight text-white mb-4">Nossos Serviços</h2>
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="space-y-4">
              {faq.map((item, i) => (
                <details
                  key={i}
                  className="group glass-card border border-white/10 hover:border-primary/30 transition-colors overflow-hidden"
                >
